...
class Recommendation {
  ...
  /// Сколько всего минут займёт предложение — фокус и перерывы между
  /// циклами.
  ///
  /// Считается по собственным полям, а не по [technique]. Разница видна
  /// только у пресетов, и там она принципиальна: у пользовательской руки
  /// `technique` — это лишь *ближайшая* встроенная техника, нужная старым
  /// местам, которые умеют работать только с перечислением. Спрашивать у
  /// неё длительности значит спрашивать не про то предложение, которое
  /// человеку показали.
